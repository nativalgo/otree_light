...
class Group(BaseGroup):
    ...
    sent_back_amount = models.IntegerField(doc='Amount sent back by P2')
...
# def sent_back_amount_error(self, value):
#     print('value is', self.sent_back_amount)
#     if self.sent_back_amount > self.sent_amount * C.MULTIPLIER:
#         return 'Cannot send more than amount received'
