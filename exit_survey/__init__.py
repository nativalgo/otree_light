...
class Player(BasePlayer):
    ...
    hours_slept = models.FloatField(label='How many hours did you sleep last night?')
    feeling_best1 = models.StringField(choices=[['1', 'Between 5 am - 6:30 am'], ['2', 'Between 6:30 am - 7:45 am'],
                                                ['3', 'Between 7:45 am - 9:45 am'], ['4', 'Between 9:45 am - 11 am'],
    ...
    tired2 = models.StringField(
        choices=[['1', 'Very tired'], ['2', 'Fairly tired'], ['3', 'Fairly refreshed'], ['4', 'Very refreshed']],
    ...
    peak4 = models.StringField(choices=[['1', 'Between 12 am - 4:30 am'], ['2', 'Between 4:30 am - 7:30 am'],
                                        ['3', 'Between 7:30 am - 8:45 am'], ['4', 'Between 8:45 am - 4:30 pm '],
    ...
    hispanic = models.StringField(choices=[['0', 'No'], ['1', 'Yes']], label='Are you Hispanic?')
    age_genpop = models.StringField(
        choices=[['1', '18-25'], ['2', '26-35'], ['3', '36-45'], ['4', '45-59'], ['5', '60+']],
    ...
    year_school = models.StringField(
        choices=[['1', '1st year undergraduate'], ['2', '2nd year undergraduate'], ['3', '3rd year undergraduate'],
                 ['4', '4th year undergraduate'], ['5', '5th+ year undergraduate'], ['6', 'Graduate student'],
